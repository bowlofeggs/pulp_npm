...
mkdir -p %{buildroot}/%{_var}/lib/pulp/published/npm

cp -R plugins/etc/httpd %{buildroot}/%{_sysconfdir}/
cp plugins/etc/pulp/vhosts80/pulp_npm.conf %{buildroot}/%{_sysconfdir}/pulp/vhosts80/
# Types
...
%package -n python-pulp-npm-common
...
%files -n python-pulp-npm-common
%defattr(-,root,root,-)
%dir %{python_sitelib}/pulp_npm
%{python_sitelib}/pulp_npm/__init__.py*
%{python_sitelib}/pulp_npm/common/
%dir %{python_sitelib}/pulp_npm/extensions
%{python_sitelib}/pulp_npm/extensions/__init__.py*
%{python_sitelib}/pulp_npm_common*.egg-info
...
Group: Development/Languages
Requires: python-pulp-common >= %{pulp_version}
Requires: python-pulp-npm-common >= %{version}
...
%files plugins
%defattr(-,root,root,-)
%{python_sitelib}/pulp_npm/plugins/
%config(noreplace) %{_sysconfdir}/httpd/conf.d/pulp_npm.conf
%config(noreplace) %{_sysconfdir}/pulp/vhosts80/pulp_npm.conf
%{_usr}/lib/pulp/plugins/types/python.json
%{python_sitelib}/pulp_npm_plugins*.egg-info
...
%defattr(-,root,root,-)
%{python_sitelib}/pulp_npm/extensions/admin/
%{python_sitelib}/pulp_npm_extensions_admin*.egg-info
%doc COPYRIGHT LICENSE AUTHORS
