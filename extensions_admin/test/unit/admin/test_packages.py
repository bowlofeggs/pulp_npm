"""
This module contains tests for the pulp_npm.extensions.admin.packages module.
"""
import unittest
...
from pulp_npm.extensions.admin import packages
...
class TestCopyPackagesCommand(unittest.TestCase):
    ...
    """
    @mock.patch('pulp_npm.extensions.admin.packages.unit.UnitCopyCommand.__init__')
    ...
    def test_get_formatter_for_type(self):
        ...
        self.assertEqual(formatter({'name': 'pulp_npm_plugins', 'version': '0.0.0'}),
                         'pulp_npm_plugins-0.0.0')
...
class TestListPackagesCommand(unittest.TestCase):
    ...
    """
    @mock.patch('pulp_npm.extensions.admin.packages.DisplayUnitAssociationsCommand.__init__')
    def test___init__(self, super___init__):
        """
        Assert correct behavior from __init__().
        """
...
class TestRemovePackagesCommand(unittest.TestCase):
    ...
    """
    @mock.patch('pulp_npm.extensions.admin.packages.UnitRemoveCommand.__init__')
    def test___init__(self, super___init__):
        """
        Assert correct behavior from __init__().
        """
